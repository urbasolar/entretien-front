    ...
    extend: {
      colors: {
        ...
        neutral: {
          ...
          dark: {
            black: 'rgba(var(--color-dark-neutral-black) / <alpha-value>)',
            gray: 'rgba(var(--color-dark-neutral-gray) / <alpha-value>)',
            light: 'rgba(var(--color-dark-neutral-light-gray) / <alpha-value>)',
          }
        },
        white: {
