...
export const Section: FC<TSection> = (props: TSection) => {
  ...
  return (
    <div
      className={`bg-neutral-dark-gray w-full h-full border-lg p-l text-white rounded-lg ${
        className ? className : ''
      }`}
    >
      {(title || headerAction || canBeClosed) && (
        <div className='border-b border-neutral-dark-light pb-s border-solid flex'>
